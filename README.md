- [Welcome](#welcome)
  - [使用方法](#使用方法)
  - [单票分析 autoanalysis](#单票分析-autoanalysis)
    - [renko](#renko)
    - [volume profile](#volume-profile)
    - [point and figure](#point-and-figure)
    - [有了砖图（Renko）vs 点数图（P\&F）](#有了砖图renkovs-点数图pf)
    - [核心差异：对称性 vs 非对称性](#核心差异对称性-vs-非对称性)
    - [实战维度的价值互补](#实战维度的价值互补)
    - [实战配置法则](#实战配置法则)
    - [P\&F 的水平计数法](#pf-的水平计数法)
    - [总结归纳](#总结归纳)
  - [全市场分析](#全市场分析)
    - [量化归因](#量化归因)
    - [多因子监控字典](#多因子监控字典)
    - [因子回测机 factor\_backtester.py](#因子回测机-factor_backtesterpy)
    - [市场雷达 market\_radar.py](#市场雷达-market_radarpy)
    - [底仓洗牌系统 auto\_portfolio\_sorter.p](#底仓洗牌系统-auto_portfolio_sorterp)
    - [脚本工作流程](#脚本工作流程)
  - [打造股票池](#打造股票池)
    - [阵营一：量价/交易型因子 (高频、短半衰期)](#阵营一量价交易型因子-高频短半衰期)
    - [阵营二：财务/基本面因子 (低频、长半衰期)](#阵营二财务基本面因子-低频长半衰期)
    - [💡 顶级游资与量化私募的终极玩法：“双重过滤架构”](#-顶级游资与量化私募的终极玩法双重过滤架构)
    - [总结与下一步](#总结与下一步)
